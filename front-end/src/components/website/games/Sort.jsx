		...
		<div className="  dark:text-cream dark:bg-blue-gray-300/70 w-52 h-screen sticky top-0 flex flex-col gap-5 capitalize justify-center p-2 mt-24  rounded-3xl rounded-tl-none border-t-4 shadow-lg border-amber ">
			<div class="relative">
				<input
					...
					class="block px-2.5 pb-2.5 pt-4 w-full text-sm dark:bg-blue-gray-600 dark:border-none text-gray-900 dark:placeholder:text-cream bg-transparent rounded-lg border-1 border-gray-300 appearance-none  dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
					placeholder="Search "
				/>
